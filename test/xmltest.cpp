...
// The example parses from the character string (above):
...

		{
			...
			// printf( "error=%d id='%s' row %d col%d\n", (int) doc.Error(), doc.ErrorDesc(), doc.ErrorRow()+1,
			// doc.ErrorCol() + 1 );
		}
...

	{
		...
		const char *expected = "Line 5 has \"quotation marks\" and 'apostrophe marks'. It also has <, >, and &, as "
		                       "well as a fake copyright \xC2\xA9.";
